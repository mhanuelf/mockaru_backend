...
module.exports = {
    PQR_LIST_PQR_PER_PRODUCT_TYPE:  "select  c.DESCRIPCION AS PRODUCTO,count(p.TIPO_PRODUCTO) as CANTIDAD, c.TIPO_PRODUCTO  from INFO_PQR p , INFO_CATALOGO c , INFO_CLIENTE cli  where p.TIPO_PRODUCTO = c.TIPO_PRODUCTO  and p.NUMERO_IDENTIFICACION = cli.NUMERO_IDENTIFICACION group by p.TIPO_PRODUCTO,  c.DESCRIPCION" ,
