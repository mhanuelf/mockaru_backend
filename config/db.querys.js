...
module.exports = {
    ...
    CLIENT_GET_CLIENT_BY_ID: "SELECT concat(NOMBRES, ' ' , APELLIDOS) AS name, COALESCE(EMAIL, 'N/A') AS email, coalesce(TELEFONO, 'N/A') AS phoneNumber FROM mockaru.INFO_CLIENTE WHERE NUMERO_IDENTIFICACION = ?"
